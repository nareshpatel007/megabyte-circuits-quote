            ...
            >
                ...
                {loadingState === "success" && (
                    <div className="flex flex-col items-center justify-center space-y-4 py-2">
                        <div className="w-14 h-14 rounded-full bg-green-50 border border-green-200 flex items-center justify-center text-green-500 animate-bounce">
                            <CheckCircle className="w-7 h-7" />
                        </div>
                        <div>
                            <p className="text-base font-bold text-gray-900">Gerber Verification Complete!</p>
                ...
                {file && loadingState !== "error" && loadingState !== "idle" && (
                    <div className="mt-6 pt-4 border-t border-slate-100 flex items-center justify-between px-2">
                        <div className="flex items-center gap-3">
                            <CheckCircle className="w-5 h-5 text-green-500 shrink-0" />
                            <div className="text-left">
                                <p className="text-sm font-semibold text-gray-800 truncate max-w-[240px]">{file.name}</p>
                        ...
                        {loadingState === "success" && (
                            <button
                                type="button"
                                onClick={resetUploader}
                                className="p-1 text-gray-400 hover:text-red-500 hover:bg-slate-100 rounded-full transition-colors cursor-pointer"
                            >
                                <X className="w-5 h-5" />
                            </button>
                        )}
