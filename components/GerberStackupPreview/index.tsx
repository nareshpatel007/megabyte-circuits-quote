    ...
    return (
        <div className="w-full">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-10 items-center justify-center">
                {/* Front View */}
                <div className="flex flex-col items-center justify-center p-2 relative group min-h-[320px]">
                    {loading ? (
                        ...
                        <div
                            ...
                            className="w-full h-full min-h-[300px] max-h-[460px] flex items-center justify-center [&>svg]:w-full [&>svg]:h-auto [&>svg]:max-h-[440px] [&>svg]:mx-auto [&>svg]:object-contain transition-transform duration-300 group-hover:scale-[1.01]"
                        />
                    ) : (
